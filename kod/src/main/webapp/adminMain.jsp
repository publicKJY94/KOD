...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="adminMain.jsp" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <!-- ./col -->
                  <div class="col-6 col-md-3 text-center">
                    <input type="text" class="knob" value="80" data-min="0" data-max="150" data-width="90"
                  ...
                  <!-- ./col -->
                  <div class="col-6 col-md-3 text-center">
                    <input type="text" class="knob" value="10" data-width="90" data-height="90" data-fgColor="#00c0ef">
                ...
                <div class="row">
                  ...
                  <!-- ./col -->
                  <div class="col-6 text-center">
                    <input type="text" class="knob" value="500" data-min="0" data-max="1000" data-width="90" data-height="90" data-fgColor="#39CCCC">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">KOD</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
