			...
			<div class="FormRow">
				...
				<div class="review-form">
					<div class="input-rating">
						<div class="stars">
							<input id="star5" name="score" value="5" type="radio"><label
								for="star5"></label> <input id="star4" name="score" value="4"
								type="radio"><label for="star4"></label> <input
								id="star3" name="score" value="3" type="radio"><label
								for="star3"></label> <input id="star2" name="score" value="2"
								type="radio"><label for="star2"></label> <input
								id="star1" name="score" value="1" type="radio"><label
								for="star1"></label>
						</div>
					</div>
				</div>
