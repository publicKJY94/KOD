		...
		<form name="joinform" onsubmit="formCheck(this);" action="join.do"
			...
			<div class="input__block" style="padding-left: 27px;">
				<input type="password" 
					...
					style="width: 85%; display: inline-block;" minlength="6"  maxlength="13"
					oninput="removeWhitespace(this)" required/><br> <!-- oninput이벤트를 사용해 사용자가 입력할때마다 공백을 제거하는 함수 호출 -->
					<label> 비밀번호는 6~13자의 영문 소문자, 숫자, 특수문자가 각각 최소 <br>1개 이상 포함되어야 합니다. </label>
			</div>
			...
			<div class="input__block" style="padding-left: 27px;">
				<input type="name" placeholder="이름을 입력해주세요" class="input"
					...
					style="width: 85%; display: inline-block;" minlength="2"  maxlength="10"
					oninput="removeWhitespace(this)" required/>
			...
			<!-- 생년월일 입력란 -->
			<div class="input__block" style="padding-left: 27px;">
				<input type="text" id="year" name="year" placeholder=" ex) 1997 " style="display: inline-block; width: 27%;" minlength="4" maxlength="4" oninput="removeWhitespace(this)" required >
			...
			<div class="input__block" style="padding-left: 27px;">
				<input type="text" id="PhNum1" name="PhNum1" placeholder=" 010 "
					...
					maxlength="3" oninput="removeWhitespace(this)" required> <span
				...
				<input type="text" id="PhNum2" name="PhNum2" placeholder=" 0000 "
					...
					maxlength="4" oninput="removeWhitespace(this)" required> <span
					style="display: inline-block; margin-left: 5px; margin-right: 5px;">-</span>
				<input type="text" id="PhNum3" name="PhNum3" placeholder=" 0000 "
					style="display: inline-block; width: 23%;" minlength="4"
					maxlength="4" oninput="removeWhitespace(this)" required>
			</div>
			...
			<div class="input__block" style="padding-left: 27px;">
				...
				<input type="text" placeholder="Email1" class="input"
					...
					style="display: inline-block; width: 25%;" oninput="removeWhitespace(this)" required /> <span
					style="display: inline-block; margin-left: 5px; margin-right: 5px;">@</span>
				<input class="input" id="domain-txt" type="text" placeholder="domain.com" name="memberEmail2" style="display: inline-block; width: 25%;" oninput="removeWhitespace(this)" required />
				<select
...
<!-- 			<script>
  ...
  function updateDomainTxt() {
	...
	<div class="input__block">
    	...
    	<input type="text" id="sample4_detailAddress" name="adrsDetail" placeholder="상세주소" style="margin-top: 5px;"oninput="removeWhitespace(this)" >
